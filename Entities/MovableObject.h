...
// Return value:    None.
    ...
    void AddImpulseForce(const Vector &impulse, const Vector &offset = Vector())
        { RTEAssert(impulse.GetLargest() < 10000, "HUEG IMPULSE FORCE"); RTEAssert(offset.GetLargest() < 1000, "HUEG IMPULSE FORCE OFFSET"); m_ImpulseForces.push_back(std::make_pair(impulse, offset)); }
...
// Return value:    None.
    ...
    void AddAbsImpulseForce(const Vector &impulse, const Vector &absPos)
        { RTEAssert(impulse.GetLargest() < 10000, "HUEG IMPULSE FORCE");
