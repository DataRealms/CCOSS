...
void GUILabel::Create(GUIProperties *Props)
{
    ...
    if (std::strcmp(alignString.c_str(), "left") == 0)
        m_HAlignment = GUIFont::Left;
    if (std::strcmp(alignString.c_str(), "centre") == 0 || std::strcmp(alignString.c_str(), "center") == 0)
        m_HAlignment = GUIFont::Centre;
    if (std::strcmp(alignString.c_str(), "right") == 0)
        m_HAlignment = GUIFont::Right;

    Props->GetValue("VAlignment", &alignString);
    if (std::strcmp(alignString.c_str(), "top") == 0)
        m_VAlignment = GUIFont::Top;
    if (std::strcmp(alignString.c_str(), "middle") == 0)
        m_VAlignment = GUIFont::Middle;
    if (std::strcmp(alignString.c_str(), "bottom") == 0)
...
void GUILabel::ApplyProperties(GUIProperties *Props)
{
    ...
    if (std::strcmp(alignString.c_str(), "left") == 0)
        m_HAlignment = GUIFont::Left;
    if (std::strcmp(alignString.c_str(), "centre") == 0)
        m_HAlignment = GUIFont::Centre;
    if (std::strcmp(alignString.c_str(), "right") == 0)
        m_HAlignment = GUIFont::Right;
