...
int main(int argc, char *argv[]) {
	...
	if (!std::experimental::filesystem::exists(screenshotSaveDir)) {
		g_System.MakeDirectory(screenshotSaveDir);
	}
	...
	if (g_ConsoleMan.LoadWarningsExist()) {
		...
		if (std::experimental::filesystem::exists(g_System.GetWorkingDirectory() + "/LogLoadingWarning.txt")) {
