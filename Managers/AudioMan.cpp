...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	bool AudioMan::Initialize() {
		...
		// Add a compressor to the sound channel group
		...
		audioSystemSetupResult = (audioSystemSetupResult == FMOD_OK) ? m_SoundChannelGroup->addDSP(0, dsp_compressor) : audioSystemSetupResult;
