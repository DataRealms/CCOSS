...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void ConsoleMan::ConsoleOpenClose() {
		...
		if (m_ConsoleState == ConsoleState::Enabling) {
			...
			travelCompletionDistance = std::std::floor(static_cast<float>(m_ParentBox->GetYPos()) * 0.5F);
			...
			travelCompletionDistance = std::std::ceil((static_cast<float>(m_ParentBox->GetHeight()) + static_cast<float>(m_ParentBox->GetYPos())) * 0.5F);
			m_ParentBox->SetPositionAbs(0, m_ParentBox->GetYPos() - static_cast<int>(travelCompletionDistance));
