...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void ConsoleMan::Update() {
		if (g_UInputMan.FlagCtrlState() && g_UInputMan.KeyPressed(SDLK_BACKQUOTE)) {
			SetReadOnly();
		}

		if (!g_UInputMan.FlagShiftState() && (!g_UInputMan.FlagCtrlState() && g_UInputMan.KeyPressed(SDLK_BACKQUOTE))) {
			if (IsEnabled()) {
				if (!m_ReadOnly) {
