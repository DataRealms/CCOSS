...
//            .property("Atom", &MOSParticle::GetAtom, &MOSParticle:SetAtom)
        ...
        CONCRETELUABINDING(MOSRotating, MOSprite)
			...
			.def("AddWound", &MOSRotating::AddWound)
			...
			.def("AddEmitter", (void (MOSRotating::*)(AEmitter *emitterToAdd))&MOSRotating::AddEmitter, adopt(_2))
			.def("AddEmitter", (void (MOSRotating::*)(AEmitter *emitterToAdd, const Vector &parentOffset))&MOSRotating::AddEmitter, adopt(_2))
