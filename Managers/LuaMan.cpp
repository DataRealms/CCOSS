...
int LuaMan::Create()
{
    ...
    [
		...
		CONCRETELUABINDING(ACrab, Actor)
            ...
            .property("LFGLeg", &ACrab::GetLeftFGLeg, &ACrab::SetLeftFGLeg, detail::null_type(), adopt(_2))
            .property("LBGLeg", &ACrab::GetLeftBGLeg, &ACrab::SetLeftBGLeg, detail::null_type(), adopt(_2))
            .property("RFGLeg", &ACrab::GetRightFGLeg, &ACrab::SetRightFGLeg, detail::null_type(), adopt(_2))
            .property("RBGLeg", &ACrab::GetRightBGLeg, &ACrab::SetRightBGLeg, detail::null_type(), adopt(_2))
