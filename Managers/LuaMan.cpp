...
int LuaMan::Create()
{
    ...
    [
        ...
        CONCRETELUABINDING(MOSRotating, MOSprite)
			...
			.def("GetGibWoundLimit", (int (MOSRotating:: *)()) &MOSRotating::GetGibWoundLimit)
            .def("GetGibWoundLimit", (int (MOSRotating:: *)(bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables)) &MOSRotating::GetGibWoundLimit)
			.def("GetWoundCount", (int (MOSRotating:: *)()) &MOSRotating::GetWoundCount)
			.def("GetWoundCount", (int (MOSRotating:: *)(bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables)) &MOSRotating::GetWoundCount)
			.def("AddWound", &MOSRotating::AddWound, adopt(_2))
			.def("RemoveWounds", (int (MOSRotating:: *)(int numberOfWoundsToRemove)) &MOSRotating::RemoveWounds)
            .def("RemoveWounds", (int (MOSRotating:: *)(int numberOfWoundsToRemove, bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables)) &MOSRotating::RemoveWounds)
        ...
        CONCRETELUABINDING(Attachable, MOSRotating)
            ...
            .property("TransfersDamageToParent", &Attachable::GetTransfersDamageToParent, &Attachable::SetTransfersDamageToParent)
            ...
            .def("GetBreakWound", &Attachable::GetBreakWound)
            .def("SetBreakWound", &Attachable::SetBreakWound)
            .def("GetParentBreakWound", &Attachable::GetParentBreakWound)
            .def("SetParentBreakWound", &Attachable::SetParentBreakWound)
        ...
        CONCRETELUABINDING(AEmitter, Attachable)
            ...
            .property("Flash", &AEmitter::GetFlash, &AEmitter::SetFlash)
		...
		CONCRETELUABINDING(AHuman, Actor)
            ...
            .property("FGArm", &AHuman::GetFGArm, &AHuman::SetFGArm)
            .property("BGArm", &AHuman::GetBGArm, &AHuman::SetBGArm)
            .property("FGLeg", &AHuman::GetFGLeg, &AHuman::SetFGLeg)
            .property("BGLeg", &AHuman::GetBGLeg, &AHuman::SetBGLeg)
		...
		CONCRETELUABINDING(ACrab, Actor)
            ...
            .def(constructor<>())
            .property("Turret", &ACrab::GetTurret, &ACrab::SetTurret)
            .property("Jetpack", &ACrab::GetJetpack, &ACrab::SetJetpack)
            .property("LFGLeg", &ACrab::GetLeftFGLeg, &ACrab::SetLeftFGLeg)
            .property("LBGLeg", &ACrab::GetLeftBGLeg, &ACrab::SetLeftBGLeg)
            .property("RFGLeg", &ACrab::GetRightFGLeg, &ACrab::SetRightFGLeg)
            .property("RBGLeg", &ACrab::GetRightBGLeg, &ACrab::SetRightBGLeg)
        ...
        CONCRETELUABINDING(ACDropShip, ACraft)
            .property("RightEngine", &ACDropShip::GetRightThruster, &ACDropShip::SetRightThruster)
            .property("LeftEngine", &ACDropShip::GetLeftThruster, &ACDropShip::SetLeftThruster)
            .property("RightThruster", &ACDropShip::GetURightThruster, &ACDropShip::SetURightThruster)
            .property("LeftThruster", &ACDropShip::GetULeftThruster, &ACDropShip::SetULeftThruster)
			.property("LeftHatch", &ACDropShip::GetLeftHatch, &ACDropShip::SetLeftHatch)
		...
		CONCRETELUABINDING(ACRocket, ACraft)
            ...
            .property("RightLeg", &ACRocket::GetRightLeg, &ACRocket::SetRightLeg)
            .property("LeftLeg", &ACRocket::GetLeftLeg, &ACRocket::SetLeftLeg)
			.property("MainEngine", &ACRocket::GetMainThruster, &ACRocket::SetMainThruster)
			.property("LeftEngine", &ACRocket::GetLeftThruster, &ACRocket::SetLeftThruster)
			.property("RightEngine", &ACRocket::GetRightThruster, &ACRocket::SetRightThruster)
			.property("LeftThruster", &ACRocket::GetULeftThruster, &ACRocket::SetULeftThruster)
			.property("RightThruster", &ACRocket::GetURightThruster, &ACRocket::SetURightThruster)
        ...
        CONCRETELUABINDING(HDFirearm, HeldDevice)
            ...
            .property("Magazine", &HDFirearm::GetMagazine, &HDFirearm::SetMagazine)
