...
int LuaMan::Create()
{
    ...
    [
		...
		class_<PrimitiveMan>("PrimitiveManager")
			...
			.def("DrawArcPrimitive", (void (PrimitiveMan::*)(Vector pos, float startAngle, float endAngle, short radius, short thickness, unsigned char color))&PrimitiveMan::DrawArcPrimitive)
			.def("DrawArcPrimitive", (void (PrimitiveMan::*)(short player, Vector pos, float startAngle, float endAngle, short radius, short thickness, unsigned char color))&PrimitiveMan::DrawArcPrimitive)
			...
			.def("DrawRoundBoxPrimitive", (void (PrimitiveMan::*)(Vector start, Vector end, float cornerRadius, unsigned char color))&PrimitiveMan::DrawRoundBoxPrimitive)
			.def("DrawRoundBoxPrimitive", (void (PrimitiveMan::*)(short player, Vector start, Vector end, float cornerRadius, unsigned char color))&PrimitiveMan::DrawRoundBoxPrimitive)
			.def("DrawRoundBoxFillPrimitive", (void (PrimitiveMan::*)(Vector start, Vector end, float cornerRadius, unsigned char color))&PrimitiveMan::DrawRoundBoxFillPrimitive)
			.def("DrawRoundBoxFillPrimitive", (void (PrimitiveMan::*)(short player, Vector start, Vector end, float cornerRadius, unsigned char color))&PrimitiveMan::DrawRoundBoxFillPrimitive)
