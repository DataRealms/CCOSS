...
//            .property("Atom", &MOSParticle::GetAtom, &MOSParticle:SetAtom)
        ...
        CONCRETELUABINDING(MOSRotating, MOSprite)
            ...
            .def("AddAttachable", (void (MOSRotating::*)(Attachable *attachableToAdd))&MOSRotating::AddAttachable)
            .def("AddAttachable", (void (MOSRotating::*)(Attachable *attachableToAdd, const Vector &parentOffset))&MOSRotating::AddAttachable)
