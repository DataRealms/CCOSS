...
int LuaMan::Create()
{
    ...
    [
        ...
        CONCRETELUABINDING(MOSRotating, MOSprite)
            ...
            .def("GetGibWoundLimit", (int (MOSRotating:: *)(bool includeAttachablesWithAPositiveDamageMultiplier, bool includeAttachablesWithANegativeDamageMultiplier, bool includeAttachablesWithNoDamageMultiplier) const) &MOSRotating::GetGibWoundLimit)
			.def("GetWoundCount", (int (MOSRotating:: *)() const) &MOSRotating::GetWoundCount)
			.def("GetWoundCount", (int (MOSRotating:: *)(bool includeAttachablesWithAPositiveDamageMultiplier, bool includeAttachablesWithANegativeDamageMultiplier, bool includeAttachablesWithNoDamageMultiplier) const) &MOSRotating::GetWoundCount)
            ...
            .def("RemoveWounds", (float (MOSRotating:: *)(int numberOfWoundsToRemove, bool includeAttachablesWithAPositiveDamageMultiplier, bool includeAttachablesWithANegativeDamageMultiplier, bool includeAttachablesWithNoDamageMultiplier)) &MOSRotating::RemoveWounds)
        ...
        CONCRETELUABINDING(Attachable, MOSRotating)
            ...
            .property("BreakWound", &Attachable::GetBreakWound, &Attachable::SetBreakWound, copy(result), adopt(_2))
            .property("ParentBreakWound", &Attachable::GetParentBreakWound, &Attachable::SetParentBreakWound, copy(result), adopt(_2))
        ...
        CONCRETELUABINDING(AEmitter, Attachable)
            ...
            .property("Flash", &AEmitter::GetFlash, &AEmitter::SetFlash, copy(result), adopt(_2))
		...
		CONCRETELUABINDING(ADoor, Actor)
            ...
            .property("Door", &ADoor::GetDoor, &ADoor::SetDoor, copy(result), adopt(_2))
        ...
        ABSTRACTLUABINDING(Leg, Attachable)
            .property("Foot", &Leg::GetFoot, &Leg::SetFoot, copy(result), adopt(_2)),
		...
		CONCRETELUABINDING(AHuman, Actor)
            ...
            .property("FGArm", &AHuman::GetFGArm, &AHuman::SetFGArm, copy(result), adopt(_2))
            .property("BGArm", &AHuman::GetBGArm, &AHuman::SetBGArm, copy(result), adopt(_2))
            .property("FGLeg", &AHuman::GetFGLeg, &AHuman::SetFGLeg, copy(result), adopt(_2))
            .property("BGLeg", &AHuman::GetBGLeg, &AHuman::SetBGLeg, copy(result), adopt(_2))
			.property("FGFoot", &AHuman::GetFGFoot, &AHuman::SetFGFoot, copy(result), adopt(_2))
			.property("BGFoot", &AHuman::GetBGFoot, &AHuman::SetBGFoot, copy(result), adopt(_2))
		...
		CONCRETELUABINDING(ACrab, Actor)
            ...
            .def(constructor<>())
            .property("Turret", &ACrab::GetTurret, &ACrab::SetTurret, copy(result), adopt(_2))
            .property("Jetpack", &ACrab::GetJetpack, &ACrab::SetJetpack, copy(result), adopt(_2))
            .property("LFGLeg", &ACrab::GetLeftFGLeg, &ACrab::SetLeftFGLeg, copy(result), adopt(_2))
            .property("LBGLeg", &ACrab::GetLeftBGLeg, &ACrab::SetLeftBGLeg, copy(result), adopt(_2))
            .property("RFGLeg", &ACrab::GetRightFGLeg, &ACrab::SetRightFGLeg, copy(result), adopt(_2))
            .property("RBGLeg", &ACrab::GetRightBGLeg, &ACrab::SetRightBGLeg, copy(result), adopt(_2))
        ...
        CONCRETELUABINDING(Turret, Attachable)
			.property("MountedDevice", &Turret::GetMountedDevice, &Turret::SetMountedDevice, copy(result), adopt(_2)),
        ...
        CONCRETELUABINDING(ACDropShip, ACraft)
            .property("RightEngine", &ACDropShip::GetRightThruster, &ACDropShip::SetRightThruster, copy(result), adopt(_2))
            .property("LeftEngine", &ACDropShip::GetLeftThruster, &ACDropShip::SetLeftThruster, copy(result), adopt(_2))
            .property("RightThruster", &ACDropShip::GetURightThruster, &ACDropShip::SetURightThruster, copy(result), adopt(_2))
            .property("LeftThruster", &ACDropShip::GetULeftThruster, &ACDropShip::SetULeftThruster, copy(result), adopt(_2))
			.property("RightHatch", &ACDropShip::GetRightHatch, &ACDropShip::SetRightHatch, copy(result), adopt(_2))
			.property("LeftHatch", &ACDropShip::GetLeftHatch, &ACDropShip::SetLeftHatch, copy(result), adopt(_2))
		...
		CONCRETELUABINDING(ACRocket, ACraft)
            ...
            .property("RightLeg", &ACRocket::GetRightLeg, &ACRocket::SetRightLeg, copy(result), adopt(_2))
            .property("LeftLeg", &ACRocket::GetLeftLeg, &ACRocket::SetLeftLeg, copy(result), adopt(_2))
			.property("MainEngine", &ACRocket::GetMainThruster, &ACRocket::SetMainThruster, copy(result), adopt(_2))
			.property("LeftEngine", &ACRocket::GetLeftThruster, &ACRocket::SetLeftThruster, copy(result), adopt(_2))
			.property("RightEngine", &ACRocket::GetRightThruster, &ACRocket::SetRightThruster, copy(result), adopt(_2))
			.property("LeftThruster", &ACRocket::GetULeftThruster, &ACRocket::SetULeftThruster, copy(result), adopt(_2))
			.property("RightThruster", &ACRocket::GetURightThruster, &ACRocket::SetURightThruster, copy(result), adopt(_2))
        ...
        CONCRETELUABINDING(HDFirearm, HeldDevice)
            ...
            .property("Magazine", &HDFirearm::GetMagazine, &HDFirearm::SetMagazine, copy(result), adopt(_2))
            .property("Flash", &HDFirearm::GetFlash, &HDFirearm::SetFlash, copy(result), adopt(_2))
