...
int LuaMan::Create()
{
    ...
    [
		...
		class_<SoundContainer>("SoundContainer")
            ...
            .property("AffectedByPitch", &SoundContainer::IsAffectedByPitch, &SoundContainer::SetAffectedByPitch),
...
//            .property("Atom", &MOSParticle::GetAtom, &MOSParticle:SetAtom)
        ...
        class_<AudioMan>("AudioManager")
            ...
            .def("PlaySound", (SoundContainer * (AudioMan:: *)(const char *filePath, float distance, int player, int loops, int priority, double pitchOrAffectedByGlobalPitch)) &AudioMan::PlaySound)
            .def("PlaySound", (bool (AudioMan:: *)(SoundContainer *pSoundContainer, float distance, int player, int priority, double pitch)) &AudioMan::PlaySound)
