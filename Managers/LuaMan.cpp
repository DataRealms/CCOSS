...
int LuaMan::Create()
{
    ...
    [
        ...
        CONCRETELUABINDING(MOSRotating, MOSprite)
            ...
            .def("GetGibWoundLimit", (int (MOSRotating:: *)(bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables) const) &MOSRotating::GetGibWoundLimit)
			.def("GetWoundCount", (int (MOSRotating:: *)() const) &MOSRotating::GetWoundCount)
			.def("GetWoundCount", (int (MOSRotating:: *)(bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables) const) &MOSRotating::GetWoundCount)
            ...
            .def("RemoveWounds", (float (MOSRotating:: *)(int numberOfWoundsToRemove, bool includeDamageTransferringAttachables, bool includeNonDamageTransferringAttachables)) &MOSRotating::RemoveWounds)
        ...
        CONCRETELUABINDING(Turret, Attachable)
			.property("MountedDevice", &Turret::GetMountedDevice, (void (Turret:: *)(Attachable *newMountedMO)) &Turret::SetMountedDevice),
