...
#pragma region Saving and Loading
		...
		bool LoadAndStartGame(const std::string &fileName);
#pragma endregion
...
#pragma endregion
	...
	private:
		...
		static const std::string c_ScriptSavesModuleName; //!< The name of the module to save games to and load them from.
