...
#pragma region Primitive Drawing
		...
		void DrawLinePrimitive(const Vector &startPos, const Vector &endPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<LinePrimitive>(-1, startPos, endPos, color));
		}
		...
		/// <param name="endPos">End position of primitive in scene coordinates.</param>
		/// <param name="color">Color to draw primitive with.</param>
		void DrawLinePrimitive(int player, const Vector &startPos, const Vector &endPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<LinePrimitive>(player, startPos, endPos, color));
		}
		...
		void DrawArcPrimitive(const Vector &centerPos, float startAngle, float endAngle, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<ArcPrimitive>(-1, centerPos, startAngle, endAngle, radius, 1, color));
		}
		...
		void DrawArcPrimitive(const Vector &centerPos, float startAngle, float endAngle, int radius, unsigned char color, int thickness) {
			m_ScheduledPrimitives.push_back(std::make_unique<ArcPrimitive>(-1, centerPos, startAngle, endAngle, radius, thickness, color));
		}
		...
		void DrawArcPrimitive(int player, const Vector &centerPos, float startAngle, float endAngle, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<ArcPrimitive>(player, centerPos, startAngle, endAngle, radius, 1, color));
		}
		...
		void DrawArcPrimitive(int player, const Vector &centerPos, float startAngle, float endAngle, int radius, unsigned char color, int thickness) {
			m_ScheduledPrimitives.push_back(std::make_unique<ArcPrimitive>(player, centerPos, startAngle, endAngle, radius, thickness, color));
		}
		...
		void DrawSplinePrimitive(const Vector &startPos, const Vector &guideA, const Vector &guideB, const Vector &endPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<SplinePrimitive>(-1, startPos, guideA, guideB, endPos, color));
		}
		...
		void DrawSplinePrimitive(int player, const Vector &startPos, const Vector &guideA, const Vector &guideB, const Vector &endPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<SplinePrimitive>(player, startPos, guideA, guideB, endPos, color));
		}
		...
		void DrawBoxPrimitive(const Vector &topLeftPos, const Vector &bottomRightPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<BoxPrimitive>(-1, topLeftPos, bottomRightPos, color));
		}
		...
		void DrawBoxPrimitive(int player, const Vector &topLeftPos, const Vector &bottomRightPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<BoxPrimitive>(player, topLeftPos, bottomRightPos, color));
		}
		...
		void DrawBoxFillPrimitive(const Vector &topLeftPos, const Vector &bottomRightPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<BoxFillPrimitive>(-1, topLeftPos, bottomRightPos, color));
		}
		...
		void DrawBoxFillPrimitive(int player, const Vector &topLeftPos, const Vector &bottomRightPos, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<BoxFillPrimitive>(player, topLeftPos, bottomRightPos, color));
		}
		...
		void DrawRoundedBoxPrimitive(const Vector &topLeftPos, const Vector &bottomRightPos, int cornerRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<RoundedBoxPrimitive>(-1, topLeftPos, bottomRightPos, cornerRadius, color));
		}
		...
		void DrawRoundedBoxPrimitive(int player, const Vector &topLeftPos, const Vector &bottomRightPos, int cornerRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<RoundedBoxPrimitive>(player, topLeftPos, bottomRightPos, cornerRadius, color));
		}
		...
		void DrawRoundedBoxFillPrimitive(const Vector &topLeftPos, const Vector &bottomRightPos, int cornerRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<RoundedBoxFillPrimitive>(-1, topLeftPos, bottomRightPos, cornerRadius, color));
		}
		...
		void DrawRoundedBoxFillPrimitive(int player, const Vector &topLeftPos, const Vector &bottomRightPos, int cornerRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<RoundedBoxFillPrimitive>(player, topLeftPos, bottomRightPos, cornerRadius, color));
		}
		...
		void DrawCirclePrimitive(const Vector &centerPos, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<CirclePrimitive>(-1, centerPos, radius, color));
		}
		...
		void DrawCirclePrimitive(int player, const Vector &centerPos, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<CirclePrimitive>(player, centerPos, radius, color));
		}
		...
		void DrawCircleFillPrimitive(const Vector &centerPos, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<CircleFillPrimitive>(-1, centerPos, radius, color));
		}
		...
		void DrawCircleFillPrimitive(int player, const Vector &centerPos, int radius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<CircleFillPrimitive>(player, centerPos, radius, color));
		}
		...
		void DrawEllipsePrimitive(const Vector &centerPos, int horizRadius, int vertRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<EllipsePrimitive>(-1, centerPos, horizRadius, vertRadius, color));
		}
		...
		void DrawEllipsePrimitive(int player, const Vector &centerPos, int horizRadius, int vertRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<EllipsePrimitive>(player, centerPos, horizRadius, vertRadius, color));
		}
		...
		void DrawEllipseFillPrimitive(const Vector &centerPos, int horizRadius, int vertRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<EllipseFillPrimitive>(-1, centerPos, horizRadius, vertRadius, color));
		}
		...
		void DrawEllipseFillPrimitive(int player, const Vector &centerPos, int horizRadius, int vertRadius, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<EllipseFillPrimitive>(player, centerPos, horizRadius, vertRadius, color));
		}
		...
		void DrawTrianglePrimitive(const Vector &pointA, const Vector &pointB, const Vector &pointC, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<TrianglePrimitive>(-1, pointA, pointB, pointC, color));
		}
		...
		void DrawTrianglePrimitive(int player, const Vector &pointA, const Vector &pointB, const Vector &pointC, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<TrianglePrimitive>(player, pointA, pointB, pointC, color));
		}
		...
		void DrawTriangleFillPrimitive(const Vector &pointA, const Vector &pointB, const Vector &pointC, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<TriangleFillPrimitive>(-1, pointA, pointB, pointC, color));
		}
		...
		void DrawTriangleFillPrimitive(int player, const Vector &pointA, const Vector &pointB, const Vector &pointC, unsigned char color) {
			m_ScheduledPrimitives.push_back(std::make_unique<TriangleFillPrimitive>(player, pointA, pointB, pointC, color));
		}
		...
		void DrawTextPrimitive(const Vector &start, const std::string &text, bool isSmall, int alignment) {
			m_ScheduledPrimitives.push_back(std::make_unique<TextPrimitive>(-1, start, text, isSmall, alignment));
		}
		...
		void DrawTextPrimitive(int player, const Vector &start, const std::string &text, bool isSmall, int alignment) {
			m_ScheduledPrimitives.push_back(std::make_unique<TextPrimitive>(player, start, text, isSmall, alignment));
		}
		...
		void DrawBitmapPrimitive(const Vector &centerPos, Entity *entity, float rotAngle, int frame) {
			DrawBitmapPrimitive(-1, centerPos, entity, rotAngle, frame, false, false);
		}
		...
		void DrawBitmapPrimitive(const Vector &centerPos, Entity *entity, float rotAngle, int frame, bool hFlipped, bool vFlipped) {
			DrawBitmapPrimitive(-1, centerPos, entity, rotAngle, frame, hFlipped, vFlipped);
		}
		...
		void DrawBitmapPrimitive(int player, const Vector &centerPos, Entity *entity, float rotAngle, int frame) {
			DrawBitmapPrimitive(player, centerPos, entity, rotAngle, frame, false, false);
		}
