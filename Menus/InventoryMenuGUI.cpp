...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int InventoryMenuGUI::SetupFullOrTransferMode() {
		...
		RTEAssert(m_GUIControlManager->Create(m_GUIScreen.get(), m_GUIInput.get(), "Data/Base.rte/GUIs/Skins", "InventoryMenuSkin.ini"), "Failed to create InventoryMenuGUI GUIControlManager and load it from Base.rte/GUIs/Skins/Menus/InventoryMenuSkin.ini");
		...
		m_GUIControlManager->Load("Data/Base.rte/GUIs/InventoryMenuGUI.ini");
