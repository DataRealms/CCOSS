...
#pragma endregion
		...
		static constexpr int c_NumberOfOfficialModulesToIgnoreWhenPopulatingKnownMods = 3; //!< The number of modules to ignore when populating the list of mods. This hack lets us ignore Metagames.rte, Saves.rte and Scenes.rte even though they're not treated as official modules by PresetMan.
