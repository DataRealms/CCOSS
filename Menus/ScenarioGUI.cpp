...
void ScenarioGUI::Draw(BITMAP *drawBitmap) const
{
	...
	int blendAmount = 120 + IRandom(-55, 55);
...
bool ScenarioGUI::StartGame()
{
	...
	for (int team = Activity::TEAM_1; team < Activity::MAXTEAMCOUNT; ++team)
    {
		...
		if (pTechItem)
		{
			...
			{
				int selection = IRandom(1, m_apTeamTechSelect[team]->GetListPanel()->GetItemList()->size() - 1);
