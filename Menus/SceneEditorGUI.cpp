...
void SceneEditorGUI::SetObjectPickerSkin(std::string filePath) {
	m_pPicker->SetSkin(filePath);
}

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

void SceneEditorGUI::SetObjectPickerBackgroundColor(int backgroundColorIndex) {
	m_pPicker->SetBackgroundColor(backgroundColorIndex);
}
