...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int DataModule::Create(const std::string &moduleName, const ProgressCallback &progressCallback) {
		...
		const std::string moduleFolder = g_PresetMan.IsModuleOfficial(m_ModuleID) ? "Data/" : "Mods/";
		Reader reader;
		std::string indexPath(moduleFolder + m_FileName + "/Index.ini");
		std::string mergedIndexPath(moduleFolder + m_FileName + "/MergedIndex.ini");
