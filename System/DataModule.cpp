...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int DataModule::Create(const std::string &moduleName, const ProgressCallback &progressCallback) {
		...
		Reader reader;
		std::string indexPath = g_PresetMan.FullModulePath(m_FileName + "/Index.ini", m_ModuleID);
		std::string mergedIndexPath = g_PresetMan.FullModulePath(m_FileName + "/MergedIndex.ini", m_ModuleID);
