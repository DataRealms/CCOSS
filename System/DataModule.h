...
#pragma endregion
	...
	protected:
		...
		version::Semver200_version m_SupportedGameVersion; //!< Game version this DataModule supports. Needs to match exactly for this DataModule to be allowed. Base DataModules don't need this.
